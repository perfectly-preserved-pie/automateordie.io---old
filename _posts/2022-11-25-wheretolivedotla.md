...
## Challenges
I've been eternally frustrated by these first two challenges and a little worried about the third one:
1. ~~Slow rendering of markers due to poor Pandas dataframe query performance~~ (I fixed this by using dl.GeoJSON to generate markers instead of the slower dl.MarkerClusterGroup method)
2. The map looks like shit on mobile
3. The inherent fragility of relying on a single source of data for a project

I'll address these 2 remaining challenges below:
